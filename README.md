...
8. implement link follow for local files (23 oct)
9. write checkhealth (23 oct)
10. what happens if we set opt.single_file to true and try running github-preview with empty buffer? (2 nov)
...
14. autoclose config select on click away (3 nov)
