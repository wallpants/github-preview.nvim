...
3. Add theme to lua config (1 nov)
4. Code line highlights when "#" in url (1 nov)
5. Option to force single-file mode (31 oct)
6. Add settings modal (per session settings override) (31 oct)
7. Write development docs (31 oct)
8. Write contribution docs (31 oct)
9. Find a way to automate building tailwind.css (31 oct)
...
13. keep track of open and closed \<details> every rerender (23 oct)
    - (quickfix?) add option to in UI to let user select if render all open or all closed (23 oct)
14. implement link follow for local files (23 oct)
15. write docs (23 oct)
16. write checkhealth (23 oct)
17. what happens if we set opt.single_file to true and try running github-preview with empty buffer? (2 nov)
18. setup dependabot (2 nov)
19. fix dark theme flash. when dotfiles theme = light, the app flashes dark before turning light (3 nov)
20. update config validation in init.lua (3 nov)
21. autoclose config select on click away (3 nov)
